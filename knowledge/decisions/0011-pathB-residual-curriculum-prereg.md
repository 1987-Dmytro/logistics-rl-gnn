...
Пиновка диапазонов (пересечений НЕТ; тест `test_residual_seed_disjoint` падает при коллизии):
...
| residual-val (пул отбора) | `generate_instance` | 4_000_000–4_000_063 |

Residual-обучение НЕ касается сидов 0–9. Тест ассертит дизъюнкцию node_id-множеств train/val-
residual с {generate_instance(0..9)}.
